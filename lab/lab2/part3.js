...
var LargeStationList = _.filter(bikeArrayClean,function(i) {
  return i[3]>20;});
  console.log(LargeStationList);

var LargeStationCount = _.countBy(bikeArrayClean, function(i) {
  return i[3]>20 ? 'Stations with more than 20 bikes' : 'Stations with fewer than 20 bikes';});
